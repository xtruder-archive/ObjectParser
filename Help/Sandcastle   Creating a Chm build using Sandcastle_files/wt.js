//Tag Version: MNP 2.2-no dcsAdSearch/2008-10-01
//This tag has been modified to remove the dcsAdSearch function.
var gTagVer = "MNP 2.2b/2008-10-01";
var gService = true;
var gTimeZone = -8;
function dcsCookie(){
...
function dcsVar(){
	...
	/* Commenting out code to avoid errors on machines without Flash. ChanksA - 5/19/2009
	WT.fi="No";
	WT.fv=(function(){
		var i,flash;
